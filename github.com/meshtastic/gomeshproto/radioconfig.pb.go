...
type GpsCoordinateFormat int32

const (
	//
	// GPS coordinates are displayed in the normal decimal degrees format:
	// DD.DDDDDD DDD.DDDDDD
	GpsCoordinateFormat_GpsFormatDec GpsCoordinateFormat = 0
	//
	// GPS coordinates are displayed in the degrees minutes seconds format:
	// DD°MM'SS"C DDD°MM'SS"C, where C is the compass point representing the locations quadrant
	GpsCoordinateFormat_GpsFormatDMS GpsCoordinateFormat = 1
	//
	// GPS coordinates are displayed in Universal Transverse Mercator format:
	// ZZB EEEEEE NNNNNNN, where Z is zone, B is band, E is easting, N is northing
	GpsCoordinateFormat_GpsFormatUTM GpsCoordinateFormat = 2
	//
	// GPS coordinates are displayed in Military Grid Reference System format:
	// ZZB CD EEEEE NNNNN, where Z is zone, B is band, C is the east 100k square, D is the north 100k square,
	// E is easting, N is northing
	GpsCoordinateFormat_GpsFormatMGRS GpsCoordinateFormat = 3
	//
	// GPS coordinates are displayed in Open Location Code (aka Plus Codes).
	GpsCoordinateFormat_GpsFormatOLC GpsCoordinateFormat = 4
	//
	...
	// N is the northing
	GpsCoordinateFormat_GpsFormatOSGR GpsCoordinateFormat = 5
)

// Enum value maps for GpsCoordinateFormat.
var (
	GpsCoordinateFormat_name = map[int32]string{
		0: "GpsFormatDec",
		1: "GpsFormatDMS",
		2: "GpsFormatUTM",
		3: "GpsFormatMGRS",
	...
	GpsCoordinateFormat_value = map[string]int32{
		"GpsFormatDec":  0,
		"GpsFormatDMS":  1,
		"GpsFormatUTM":  2,
		"GpsFormatMGRS": 3,
...
func (x GpsCoordinateFormat) Enum() *GpsCoordinateFormat {
	p := new(GpsCoordinateFormat)
	*p = x
	return p
}

func (x GpsCoordinateFormat) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GpsCoordinateFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_radioconfig_proto_enumTypes[3].Descriptor()
}

func (GpsCoordinateFormat) Type() protoreflect.EnumType {
	return &file_radioconfig_proto_enumTypes[3]
}

func (x GpsCoordinateFormat) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GpsCoordinateFormat.Descriptor instead.
func (GpsCoordinateFormat) EnumDescriptor() ([]byte, []int) {
...
func (LocationSharing) EnumDescriptor() ([]byte, []int) {
	return file_radioconfig_proto_rawDescGZIP(), []int{4}
}
...
type PositionFlags int32

const (
	// Required for compilation
	PositionFlags_POS_UNDEFINED PositionFlags = 0
	// Include an altitude value (if available)
	PositionFlags_POS_ALTITUDE PositionFlags = 1
	// Altitude value is MSL
	PositionFlags_POS_ALT_MSL PositionFlags = 2
	// Include geoidal separation
	PositionFlags_POS_GEO_SEP PositionFlags = 4
	// Include the DOP value ; PDOP used by default, see below
	PositionFlags_POS_DOP PositionFlags = 8
	// If POS_DOP set, send separate HDOP / VDOP values instead of PDOP
	PositionFlags_POS_HVDOP PositionFlags = 16
	// Include battery level
	PositionFlags_POS_BATTERY PositionFlags = 32
	// Include number of "satellites in view"
	PositionFlags_POS_SATINVIEW PositionFlags = 64
	// Include a sequence number incremented per packet
	PositionFlags_POS_SEQ_NOS PositionFlags = 128
	// Include positional timestamp (from GPS solution)
	PositionFlags_POS_TIMESTAMP PositionFlags = 256
)

// Enum value maps for PositionFlags.
var (
	PositionFlags_name = map[int32]string{
		0:   "POS_UNDEFINED",
		1:   "POS_ALTITUDE",
		2:   "POS_ALT_MSL",
		4:   "POS_GEO_SEP",
	...
	PositionFlags_value = map[string]int32{
		"POS_UNDEFINED": 0,
		"POS_ALTITUDE":  1,
		"POS_ALT_MSL":   2,
		"POS_GEO_SEP":   4,
...
func (x PositionFlags) Enum() *PositionFlags {
	p := new(PositionFlags)
	*p = x
	return p
}

func (x PositionFlags) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PositionFlags) Descriptor() protoreflect.EnumDescriptor {
	return file_radioconfig_proto_enumTypes[5].Descriptor()
}

func (PositionFlags) Type() protoreflect.EnumType {
	return &file_radioconfig_proto_enumTypes[5]
}

func (x PositionFlags) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PositionFlags.Descriptor instead.
func (PositionFlags) EnumDescriptor() ([]byte, []int) {
	return file_radioconfig_proto_rawDescGZIP(), []int{5}
}
...
const (
	...
	RadioConfig_UserPreferences_DS18B20 RadioConfig_UserPreferences_EnvironmentalMeasurementSensorType = 1
)
...
type RadioConfig_UserPreferences struct {
	...
	// We should send our position this often (but only if it has changed significantly)
	// Defaults to 15 minutes
	PositionBroadcastSmart bool `protobuf:"varint,17,opt,name=position_broadcast_smart,json=positionBroadcastSmart,proto3" json:"position_broadcast_smart,omitempty"`
	//
	...
	GpsAccept_2D bool `protobuf:"varint,45,opt,name=gps_accept_2d,json=gpsAccept2d,proto3" json:"gps_accept_2d,omitempty"`
	//
	...
	GpsMaxDop uint32 `protobuf:"varint,46,opt,name=gps_max_dop,json=gpsMaxDop,proto3" json:"gps_max_dop,omitempty"`
	//
	...
	//
	// How the GPS coordinates are displayed on the OLED screen.
	GpsFormat GpsCoordinateFormat `protobuf:"varint,44,opt,name=gps_format,json=gpsFormat,proto3,enum=GpsCoordinateFormat" json:"gps_format,omitempty"`
	//
	...
	StoreForwardPluginHeartbeat           bool   `protobuf:"varint,149,opt,name=store_forward_plugin_heartbeat,json=storeForwardPluginHeartbeat,proto3" json:"store_forward_plugin_heartbeat,omitempty"`
	...
	StoreForwardPluginHistoryReturnMax    uint32 `protobuf:"varint,138,opt,name=store_forward_plugin_history_return_max,json=storeForwardPluginHistoryReturnMax,proto3" json:"store_forward_plugin_history_return_max,omitempty"`
	StoreForwardPluginHistoryReturnWindow uint32 `protobuf:"varint,139,opt,name=store_forward_plugin_history_return_window,json=storeForwardPluginHistoryReturnWindow,proto3" json:"store_forward_plugin_history_return_window,omitempty"`
	//
	...
	PositionFlags uint32 `protobuf:"varint,150,opt,name=position_flags,json=positionFlags,proto3" json:"position_flags,omitempty"`
	//
	...
	IsAlwaysPowered bool `protobuf:"varint,151,opt,name=is_always_powered,json=isAlwaysPowered,proto3" json:"is_always_powered,omitempty"`
	//
	// Automatically toggles to the next page on the screen like a carousel, based the specified interval in seconds.
	// Potentially useful for devices without user buttons.
	AutoScreenCarouselSecs uint32 `protobuf:"varint,152,opt,name=auto_screen_carousel_secs,json=autoScreenCarouselSecs,proto3" json:"auto_screen_carousel_secs,omitempty"`
	//
	// If non-zero, the device will fully power off this many seconds after external power is removed.
	//
	OnBatteryShutdownAfterSecs uint32 `protobuf:"varint,153,opt,name=on_battery_shutdown_after_secs,json=onBatteryShutdownAfterSecs,proto3" json:"on_battery_shutdown_after_secs,omitempty"`
	//
	// Overrides HOPS_RELIABLE and sets the maximum number of hops. This can't be greater than 7.
	//
	HopLimit uint32 `protobuf:"varint,154,opt,name=hop_limit,json=hopLimit,proto3" json:"hop_limit,omitempty"`
	//
	// MQTT username to use (most useful for a custom MQTT server).
	// If using a custom server, this will be honoured even if empty.
	// If using the default server, this will only be honoured if set, otherwise the device will use the default username
	MqttUsername string `protobuf:"bytes,155,opt,name=mqtt_username,json=mqttUsername,proto3" json:"mqtt_username,omitempty"`
	//
	// MQTT password to use (most useful for a custom MQTT server).
	// If using a custom server, this will be honoured even if empty.
	// If using the default server, this will only be honoured if set, otherwise the device will use the default password
	MqttPassword string `protobuf:"bytes,156,opt,name=mqtt_password,json=mqttPassword,proto3" json:"mqtt_password,omitempty"`
}
...
func (x *RadioConfig_UserPreferences) GetPositionBroadcastSmart() bool {
	if x != nil {
		return x.PositionBroadcastSmart
	}
	return false
}
...
func (x *RadioConfig_UserPreferences) GetGpsAccept_2D() bool {
	if x != nil {
		return x.GpsAccept_2D
	}
	return false
}

func (x *RadioConfig_UserPreferences) GetGpsMaxDop() uint32 {
	if x != nil {
		return x.GpsMaxDop
	}
	return 0
...
func (x *RadioConfig_UserPreferences) GetGpsFormat() GpsCoordinateFormat {
	if x != nil {
		return x.GpsFormat
	}
	return GpsCoordinateFormat_GpsFormatDec
}
...
func (x *RadioConfig_UserPreferences) GetStoreForwardPluginHeartbeat() bool {
	if x != nil {
		return x.StoreForwardPluginHeartbeat
	}
	return false
}
...
func (x *RadioConfig_UserPreferences) GetStoreForwardPluginHistoryReturnMax() uint32 {
	if x != nil {
		return x.StoreForwardPluginHistoryReturnMax
	}
	return 0
}

func (x *RadioConfig_UserPreferences) GetStoreForwardPluginHistoryReturnWindow() uint32 {
	if x != nil {
		return x.StoreForwardPluginHistoryReturnWindow
	}
	return 0
}
...
func (x *RadioConfig_UserPreferences) GetPositionFlags() uint32 {
	if x != nil {
...
func (x *RadioConfig_UserPreferences) GetIsAlwaysPowered() bool {
	if x != nil {
		return x.IsAlwaysPowered
	}
	return false
}

func (x *RadioConfig_UserPreferences) GetAutoScreenCarouselSecs() uint32 {
	if x != nil {
...
func (x *RadioConfig_UserPreferences) GetOnBatteryShutdownAfterSecs() uint32 {
	if x != nil {
...
func (x *RadioConfig_UserPreferences) GetHopLimit() uint32 {
	if x != nil {
		return x.HopLimit
	}
	return 0
...
func (x *RadioConfig_UserPreferences) GetMqttUsername() string {
	if x != nil {
...
func (x *RadioConfig_UserPreferences) GetMqttPassword() string {
	if x != nil {
...
var file_radioconfig_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xda, 0x1f, 0x0a, 0x0b, 0x52, 0x61, 0x64, 0x69, 0x6f, 0x43, 0x6f, 0x6e,
	...
	0x63, 0x65, 0x73, 0x1a, 0x8a, 0x1f, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x65, 0x66,
	...
	0x38, 0x0a, 0x18, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x62, 0x72, 0x6f, 0x61,
	0x64, 0x63, 0x61, 0x73, 0x74, 0x5f, 0x73, 0x6d, 0x61, 0x72, 0x74, 0x18, 0x11, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x16, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x72, 0x6f, 0x61, 0x64,
	0x63, 0x61, 0x73, 0x74, 0x53, 0x6d, 0x61, 0x72, 0x74, 0x12, 0x2e, 0x0a, 0x13, 0x73, 0x65, 0x6e,
	0x64, 0x5f, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11, 0x73, 0x65, 0x6e, 0x64, 0x4f, 0x77, 0x6e, 0x65,
	0x72, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x2e, 0x0a, 0x13, 0x77, 0x61, 0x69,
	...
	,
	...
	,
	...
	,
...
var file_radioconfig_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
...
var file_radioconfig_proto_goTypes = []interface{}{
	...
	(GpsCoordinateFormat)(0), // 3: GpsCoordinateFormat
	(LocationSharing)(0),     // 4: LocationSharing
	(PositionFlags)(0),       // 5: PositionFlags
	(RadioConfig_UserPreferences_EnvironmentalMeasurementSensorType)(0), // 6: RadioConfig.UserPreferences.EnvironmentalMeasurementSensorType
	(*RadioConfig)(nil),                 // 7: RadioConfig
	(*RadioConfig_UserPreferences)(nil), // 8: RadioConfig.UserPreferences
}
var file_radioconfig_proto_depIdxs = []int32{
	8, // 0: RadioConfig.preferences:type_name -> RadioConfig.UserPreferences
	...
	4, // 3: RadioConfig.UserPreferences.location_share:type_name -> LocationSharing
	2, // 4: RadioConfig.UserPreferences.gps_operation:type_name -> GpsOperation
	3, // 5: RadioConfig.UserPreferences.gps_format:type_name -> GpsCoordinateFormat
	6, // 6: RadioConfig.UserPreferences.environmental_measurement_plugin_sensor_type:type_name -> RadioConfig.UserPreferences.EnvironmentalMeasurementSensorType
