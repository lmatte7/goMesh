...
const (
	Team_CLEAR      Team = 0 // the default (unset) is "achromatic" (unaffiliated)
	Team_CYAN       Team = 1
	Team_WHITE      Team = 2
	Team_YELLOW     Team = 3
	Team_ORANGE     Team = 4
...
const (
	Position_LOCSRC_UNSPECIFIED  Position_LocSource = 0
	Position_LOCSRC_MANUAL_ENTRY Position_LocSource = 1
	Position_LOCSRC_GPS_INTERNAL Position_LocSource = 2
	Position_LOCSRC_GPS_EXTERNAL Position_LocSource = 3
)

// Enum value maps for Position_LocSource.
var (
	Position_LocSource_name = map[int32]string{
		0: "LOCSRC_UNSPECIFIED",
		1: "LOCSRC_MANUAL_ENTRY",
		2: "LOCSRC_GPS_INTERNAL",
		3: "LOCSRC_GPS_EXTERNAL",
	}
...
const (
	Position_ALTSRC_UNSPECIFIED  Position_AltSource = 0
	Position_ALTSRC_MANUAL_ENTRY Position_AltSource = 1
	Position_ALTSRC_GPS_INTERNAL Position_AltSource = 2
	Position_ALTSRC_GPS_EXTERNAL Position_AltSource = 3
	Position_ALTSRC_BAROMETRIC   Position_AltSource = 4
)

// Enum value maps for Position_AltSource.
var (
	Position_AltSource_name = map[int32]string{
		0: "ALTSRC_UNSPECIFIED",
		1: "ALTSRC_MANUAL_ENTRY",
		2: "ALTSRC_GPS_INTERNAL",
		3: "ALTSRC_GPS_EXTERNAL",
		4: "ALTSRC_BAROMETRIC",
	}
...
func (MeshPacket_Delayed) EnumDescriptor() ([]byte, []int) {
	return file_mesh_proto_rawDescGZIP(), []int{5, 1}
}
...
type Position struct {
	...
	LocationSource Position_LocSource `protobuf:"varint,10,opt,name=location_source,json=locationSource,proto3,enum=Position_LocSource" json:"location_source,omitempty"`
	AltitudeSource Position_AltSource `protobuf:"varint,11,opt,name=altitude_source,json=altitudeSource,proto3,enum=Position_AltSource" json:"altitude_source,omitempty"`
	//
	// Positional timestamp (actual timestamp of GPS solution) in integer epoch seconds
	PosTimestamp uint32 `protobuf:"fixed32,12,opt,name=pos_timestamp,json=posTimestamp,proto3" json:"pos_timestamp,omitempty"`
	//
	// Pos. timestamp milliseconds adjustment (rarely available or required)
	PosTimeMillis int32 `protobuf:"varint,13,opt,name=pos_time_millis,json=posTimeMillis,proto3" json:"pos_time_millis,omitempty"`
	//
	// HAE altitude in meters - can be used instead of MSL altitude
	AltitudeHae int32 `protobuf:"zigzag32,14,opt,name=altitude_hae,json=altitudeHae,proto3" json:"altitude_hae,omitempty"`
	//
	// Geoidal separation in meters
	AltGeoidSep int32 `protobuf:"zigzag32,15,opt,name=alt_geoid_sep,json=altGeoidSep,proto3" json:"alt_geoid_sep,omitempty"`
	//
	// Horizontal, Vertical and Position Dilution of Precision, in 1/100 units
	// - PDOP is sufficient for most cases
	// - for higher precision scenarios, HDOP and VDOP can be used instead,
	//   in which case PDOP becomes redundant (PDOP=sqrt(HDOP^2 + VDOP^2))
	PDOP uint32 `protobuf:"varint,16,opt,name=PDOP,proto3" json:"PDOP,omitempty"`
	HDOP uint32 `protobuf:"varint,17,opt,name=HDOP,proto3" json:"HDOP,omitempty"`
	VDOP uint32 `protobuf:"varint,18,opt,name=VDOP,proto3" json:"VDOP,omitempty"`
	//
	// GPS accuracy (a hardware specific constant) in mm
	//   multiplied with DOP to calculate positional accuracy
	// Default: "'bout three meters-ish" :)
	GpsAccuracy uint32 `protobuf:"varint,19,opt,name=gps_accuracy,json=gpsAccuracy,proto3" json:"gps_accuracy,omitempty"`
	//
	...
	GroundSpeed uint32 `protobuf:"varint,20,opt,name=ground_speed,json=groundSpeed,proto3" json:"ground_speed,omitempty"`
	GroundTrack uint32 `protobuf:"varint,21,opt,name=ground_track,json=groundTrack,proto3" json:"ground_track,omitempty"`
	//
	// GPS fix quality (from NMEA GxGGA statement or similar)
	FixQuality uint32 `protobuf:"varint,22,opt,name=fix_quality,json=fixQuality,proto3" json:"fix_quality,omitempty"`
	//
	// GPS fix type 2D/3D (from NMEA GxGSA statement)
	FixType uint32 `protobuf:"varint,23,opt,name=fix_type,json=fixType,proto3" json:"fix_type,omitempty"`
	//
	// GPS "Satellites in View" number
	SatsInView uint32 `protobuf:"varint,24,opt,name=sats_in_view,json=satsInView,proto3" json:"sats_in_view,omitempty"`
	//
	// Sensor ID - in case multiple positioning sensors are being used
	SensorId uint32 `protobuf:"varint,25,opt,name=sensor_id,json=sensorId,proto3" json:"sensor_id,omitempty"`
	//
	// Estimated/expected time (in seconds) until next update:
	// - if we update at fixed intervals of X seconds, use X
	// - if we update at dynamic intervals (based on relative movement etc),
	//   but "AT LEAST every Y seconds", use Y
	PosNextUpdate uint32 `protobuf:"varint,40,opt,name=pos_next_update,json=posNextUpdate,proto3" json:"pos_next_update,omitempty"`
	//
	// A sequence number, incremented with each Position message to help
	//   detect lost updates if needed
	PosSeqNumber uint32 `protobuf:"varint,41,opt,name=pos_seq_number,json=posSeqNumber,proto3" json:"pos_seq_number,omitempty"`
}
...
func (x *Position) GetLocationSource() Position_LocSource {
	...
	return Position_LOCSRC_UNSPECIFIED
}
...
func (x *Position) GetAltitudeSource() Position_AltSource {
	...
	return Position_ALTSRC_UNSPECIFIED
}

func (x *Position) GetPosTimestamp() uint32 {
	if x != nil {
		return x.PosTimestamp
	}
	return 0
}

func (x *Position) GetPosTimeMillis() int32 {
	if x != nil {
		return x.PosTimeMillis
	}
	return 0
}
...
func (x *Position) GetAltGeoidSep() int32 {
	if x != nil {
		return x.AltGeoidSep
	}
	return 0
}
...
func (x *Position) GetPosNextUpdate() uint32 {
	if x != nil {
		return x.PosNextUpdate
	}
	return 0
}

func (x *Position) GetPosSeqNumber() uint32 {
	if x != nil {
		return x.PosSeqNumber
	}
	return 0
}
...
type User struct {
	...
	Team Team `protobuf:"varint,8,opt,name=team,proto3,enum=Team" json:"team,omitempty"`
	//
	...
	TxPowerDbm uint32 `protobuf:"varint,10,opt,name=tx_power_dbm,json=txPowerDbm,proto3" json:"tx_power_dbm,omitempty"`
	//
	// Antenna gain (applicable to both Tx and Rx), in decibel-isotropic
	AntGainDbi uint32 `protobuf:"varint,11,opt,name=ant_gain_dbi,json=antGainDbi,proto3" json:"ant_gain_dbi,omitempty"`
	//
	...
	AntAzimuth uint32 `protobuf:"varint,12,opt,name=ant_azimuth,json=antAzimuth,proto3" json:"ant_azimuth,omitempty"`
}
...
func (x *User) GetTxPowerDbm() uint32 {
	if x != nil {
		return x.TxPowerDbm
	}
	return 0
...
func (x *User) GetAntGainDbi() uint32 {
	if x != nil {
		return x.AntGainDbi
	}
	return 0
...
func (x *User) GetAntAzimuth() uint32 {
	if x != nil {
		return x.AntAzimuth
	}
	return 0
...
type MeshPacket struct {
	...
	Delayed MeshPacket_Delayed `protobuf:"varint,15,opt,name=delayed,proto3,enum=MeshPacket_Delayed" json:"delayed,omitempty"`
	//
	// If set, this message is intened to be a reply to a previously sent message with the defined id.
	ReplyId uint32 `protobuf:"fixed32,16,opt,name=reply_id,json=replyId,proto3" json:"reply_id,omitempty"`
	//
	// Defaults to false. If true, then what is in the payload should be treated as an emoji like giving
	// a message a heart or poop emoji.
	IsTapback bool `protobuf:"varint,17,opt,name=is_tapback,json=isTapback,proto3" json:"is_tapback,omitempty"`
}
...
func (x *MeshPacket) GetReplyId() uint32 {
	if x != nil {
		return x.ReplyId
	}
	return 0
...
func (x *MeshPacket) GetIsTapback() bool {
	if x != nil {
		return x.IsTapback
	}
	return false
...
type MyNodeInfo struct {
	...
	Bitrate float32 `protobuf:"fixed32,11,opt,name=bitrate,proto3" json:"bitrate,omitempty"`
	//
	...
	AirPeriodTx []uint32 `protobuf:"varint,16,rep,packed,name=air_period_tx,json=airPeriodTx,proto3" json:"air_period_tx,omitempty"`
	//
	// 48 time windows of 1hr each with the airtime of valid packets for your mesh.
	AirPeriodRx []uint32 `protobuf:"varint,17,rep,packed,name=air_period_rx,json=airPeriodRx,proto3" json:"air_period_rx,omitempty"`
	//
	// Is the device wifi capable?
	HasWifi bool `protobuf:"varint,18,opt,name=has_wifi,json=hasWifi,proto3" json:"has_wifi,omitempty"`
	//
	// Utilization for the current channel, including well formed TX, RX and malformed RX (aka noise).
	ChannelUtilization float32 `protobuf:"fixed32,19,opt,name=channel_utilization,json=channelUtilization,proto3" json:"channel_utilization,omitempty"`
}
...
var file_mesh_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x08, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x45, 0x43, 0x54, 0x10, 0x02, 0x42, 0x10, 0x0a, 0x0e, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	0x64, 0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x22, 0x8f, 0x01, 0x0a, 0x08, 0x4e, 0x6f, 0x64,
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x12, 0x19, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73,
	0x65, 0x72, 0x12, 0x25, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x73, 0x6e, 0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x6c,
	0x61, 0x73, 0x74, 0x5f, 0x68, 0x65, 0x61, 0x72, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x07, 0x52,
	0x09, 0x6c, 0x61, 0x73, 0x74, 0x48, 0x65, 0x61, 0x72, 0x64, 0x22, 0xa4, 0x05, 0x0a, 0x0a, 0x4d,
	...
	,
	...
	,
	...
	0x0b, 0x2e, 0x4d, 0x79, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x48, 0x00, 0x52, 0x06,
	0x6d, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x28, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x4e, 0x6f, 0x64, 0x65,
	0x49, 0x6e, 0x66, 0x6f, 0x48, 0x00, 0x52, 0x08, 0x6e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66, 0x6f,
	0x12, 0x2b, 0x0a, 0x0a, 0x6c, 0x6f, 0x67, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64,
	...
	,
	...
	,
	...
	,
	...
	0x48, 0x03, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d,
	0x65, 0x73, 0x68, 0x74, 0x61, 0x73, 0x74, 0x69, 0x63, 0x2f, 0x67, 0x6f, 0x6d, 0x65, 0x73, 0x68,
...
var file_mesh_proto_goTypes = []interface{}{
	...
	(Team)(0),                // 1: Team
	(Constants)(0),           // 2: Constants
	(CriticalErrorCode)(0),   // 3: CriticalErrorCode
	(Position_LocSource)(0),  // 4: Position.LocSource
	(Position_AltSource)(0),  // 5: Position.AltSource
	(Routing_Error)(0),       // 6: Routing.Error
	(MeshPacket_Priority)(0), // 7: MeshPacket.Priority
	(MeshPacket_Delayed)(0),  // 8: MeshPacket.Delayed
	(LogRecord_Level)(0),     // 9: LogRecord.Level
	(*Position)(nil),         // 10: Position
	(*User)(nil),             // 11: User
	(*RouteDiscovery)(nil),   // 12: RouteDiscovery
	(*Routing)(nil),          // 13: Routing
	(*Data)(nil),             // 14: Data
	(*MeshPacket)(nil),       // 15: MeshPacket
	(*NodeInfo)(nil),         // 16: NodeInfo
	(*MyNodeInfo)(nil),       // 17: MyNodeInfo
	(*LogRecord)(nil),        // 18: LogRecord
	(*FromRadio)(nil),        // 19: FromRadio
	(*ToRadio)(nil),          // 20: ToRadio
	(*ToRadio_PeerInfo)(nil), // 21: ToRadio.PeerInfo
	(PortNum)(0),             // 22: PortNum
}
var file_mesh_proto_depIdxs = []int32{
	4,  // 0: Position.location_source:type_name -> Position.LocSource
	5,  // 1: Position.altitude_source:type_name -> Position.AltSource
	0,  // 2: User.hw_model:type_name -> HardwareModel
	1,  // 3: User.team:type_name -> Team
	12, // 4: Routing.route_request:type_name -> RouteDiscovery
	12, // 5: Routing.route_reply:type_name -> RouteDiscovery
	6,  // 6: Routing.error_reason:type_name -> Routing.Error
	22, // 7: Data.portnum:type_name -> PortNum
	14, // 8: MeshPacket.decoded:type_name -> Data
	7,  // 9: MeshPacket.priority:type_name -> MeshPacket.Priority
	8,  // 10: MeshPacket.delayed:type_name -> MeshPacket.Delayed
	11, // 11: NodeInfo.user:type_name -> User
	10, // 12: NodeInfo.position:type_name -> Position
	3,  // 13: MyNodeInfo.error_code:type_name -> CriticalErrorCode
	9,  // 14: LogRecord.level:type_name -> LogRecord.Level
	15, // 15: FromRadio.packet:type_name -> MeshPacket
	17, // 16: FromRadio.my_info:type_name -> MyNodeInfo
	16, // 17: FromRadio.node_info:type_name -> NodeInfo
	18, // 18: FromRadio.log_record:type_name -> LogRecord
	15, // 19: ToRadio.packet:type_name -> MeshPacket
	21, // 20: ToRadio.peer_info:type_name -> ToRadio.PeerInfo
